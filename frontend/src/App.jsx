...
async function downloadPDFReport(data) {
  ...
  for (let p = 1; p <= total; p++) {
    doc.setPage(p);
    doc.setFont("courier","normal"); doc.setFontSize(6); doc.setTextColor("#4a5568");
    doc.text("Version: v1.0 | Report generated by ResumeIX | Created by Arjit Gupta", M, H - 5);
    doc.setFontSize(6.5); doc.setTextColor("#1a1a32");
